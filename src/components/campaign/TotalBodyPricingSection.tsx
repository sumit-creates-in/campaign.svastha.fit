    ...
    <section id="pricing" className="py-20 px-4 bg-gradient-to-b from-white to-gray-50">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-6xl mx-auto">
          {/* VIP Plan */}
          <div className="bg-white rounded-3xl shadow-xl border-2 border-pink-300 hover:border-pink-500 transition-all duration-300 relative overflow-visible">
            <div className="absolute top-2 right-2 bg-yellow-400 text-gray-900 px-4 py-1 rounded-full text-sm font-bold z-10">
              POPULAR
            </div>
            <div className="bg-gradient-to-r from-pink-500 to-fuchsia-600 text-white p-8 text-center">
              <h3 className="text-3xl font-bold mb-2">
                ...
                <span className="block">21 Day Transformation Plan</span>
              </h3>
