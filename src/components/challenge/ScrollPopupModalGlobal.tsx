...
export const ScrollPopupModalGlobal = ({
    ...
    groupDiscountText = "Rs. 200 off",
    groupPriceText = "Rs.1290",
    joinGroupButtonText,
    isGlobal = false,
    hideGroupPlan = false,
                ...
                <div className="px-6 py-6 pt-10">
                    ...
                    <div className="mb-3">
                        ...
                        <Button
                            ...
                            className="w-full bg-gradient-to-r from-green-600 to-lime-400 text-white font-semibold text-sm py-2.5 rounded-full shadow-md transition-all duration-300 mb-3 mt-2 flex flex-col items-center leading-tight gap-0.5"
                        >
                    ...
                    {!hideGroupPlan && (
                        <>
                            ...
                            <Button
                                ...
                                className="w-full bg-gradient-to-r from-green-600 to-lime-400 text-white font-semibold text-[12px] py-2.5 rounded-full shadow-md transition-all duration-300"
                            >
