            ...
            <section className="py-12 px-3 md:px-4">
                <div className="container mx-auto max-w-4xl">
                    ...
                    <motion.div
                        ...
                        className="bg-white rounded-2xl shadow-lg p-6 md:p-12 mb-8 border-2 border-purple-200"
                    >
                        <div className="flex items-start gap-3 mb-6">
                            <Phone className="w-8 h-8 md:w-10 md:h-10 text-purple-600 flex-shrink-0" />
                            <h2 className="text-xl md:text-2xl font-bold text-gray-900">
                                We will call you soon<br className="md:hidden" />
                                <span className="hidden md:inline"> </span><span className="whitespace-nowrap">to schedule your plan!</span>
                            </h2>
                        </div>
                    ...
                    <motion.div
                        ...
                        className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl shadow-lg p-6 md:p-12 border-2 border-green-200"
                    >
                        ...
                        <div className="space-y-6">
                            ...
                            >
                                <Mail className="w-7 h-7 md:w-8 md:h-8 text-purple-600 flex-shrink-0 mt-1" />
